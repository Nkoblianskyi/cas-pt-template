...
export function Hero() {
  ...
  return (
    <section className="relative py-4 md:py-6 overflow-hidden max-h-[200px] md:max-h-[300px]">
      <div className="absolute inset-0 bg-black/80"></div>

      <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
        <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-3 lg:gap-6 max-w-7xl mx-auto">
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="text-xl md:text-3xl lg:text-4xl font-bold font-playfair leading-tight mb-2 md:mb-3">
